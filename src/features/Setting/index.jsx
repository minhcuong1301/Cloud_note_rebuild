...
function Settings({ setDf_nav, setColorNote, setUser }) {
    ...
    const [infoUser, setInfoUser] = useState(user.profile)
    ...
    const handleEditProfile = async () => {
        ...
        try {
            ...
            const response = await dispatch(updateProfile({ userId: user.id, updatedFields: formData }));
            console.log(response);
            setRe(response.payload)
            if (response.payload) {
                dispatch(updateUser({ Avarta: response.payload.Avarta, AvtProfile: response.payload.AvtProfile }));
                console.log('222',response.payload);
                console.log('1', response.payload.Avarta, response.payload.AvtProfile);
                ...
                <Grid item xs={24} sm={12} md={6} lg={6}>
                    <Box sx={{ mb: 3 }}>
                        ...
                        <BoxDoubleContent
                            ...
                            content_2={
                                <div className='avt'>
                                    ...
                                    {/* {console.log("avtUser", user.profile.Avarta)}{console.log("avtInfouser", infoUser.Avarta)} */}
                        ...
                        <BoxDoubleContent
                            ...
                            content_2={<TextField id="outlined-basic" variant="outlined" value={editedName} onChange={handleNameChange} />}
