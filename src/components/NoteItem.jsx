...
function NoteItem({ dataItem, handleDelNote, setArchivedData, construct, full = false }) {
    ...
    return (
        <div
            style={{
                ...
                position: "relative",
                width: "100%",
                maxWidth: `${full ? "calc(100% - 30px)" : construct === "Grid" ? "350px" : "none"}`,
                minHeight: `${full ? "50vh" : "auto"}`,
            ...
            >
                ...
                <DialogContent sx={{ padding: "20px 20px 20px 40px", color: "rgba(0, 0, 0, 0.6)" }}>
                    <ul>
                        <li>
                            <strong>Button Delete: </strong>Your note will be <b>permanently deleted </b> when
                            clicking delete button
                        </li>
                        <li>
                            <strong>Button Move Trash: </strong>Your notes will be deleted and then moved to the{" "}
                            <b>trash bin</b>. You can restore it
                        </li>
                        <li>
                ...
                <DialogActions>
                    ...
                    <Button onClick={handleMoveTrash}>Move Trash</Button>
                </DialogActions>
            </Dialog>
                                    ...
                                    return (
                                        <ListItem
                                            sx={{
                                                ...
                                                borderLeft: `3px solid ${item.status ? "#0C66E4" : "transparent"}`,
                                                backgroundColor: `${item.status ? "rgba(9, 30, 66, 0.0588235) !important" : "transparent"
                                                    }`,
                                            }}
                                            key={item.id}
                                            disablePadding
